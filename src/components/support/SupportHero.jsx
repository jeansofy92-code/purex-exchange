...
function SupportHero() {
  return (
    <section className="relative pt-10 pb-8 sm:pt-14 sm:pb-12 overflow-hidden border-b border-white/10 bg-[#0c0e22]">
      {/* Background ambient lighting */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-[#ff7a00]/10 blur-[150px] rounded-full pointer-events-none -z-10" />

      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          {/* Left Title & Status */}
          <div className="space-y-4 text-center lg:text-left max-w-2xl">
            <div className="inline-flex items-center gap-2.5 rounded-full border border-[#ff7a00]/40 bg-[#ff7a00]/10 px-4 py-1.5 text-xs font-bold text-[#ff7a00] backdrop-blur-md shadow-[0_0_20px_rgba(255,122,0,0.2)]">
            ...
            {/* Micro SLA Badges */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-1 text-xs text-slate-300 font-medium">
              ...
              <span>•</span>
              <div className="flex items-center gap-1.5">
                <Headphones size={14} className="text-[#ff7a00]" />
          ...
          <motion.div
            ...
            className="flex items-center gap-4 p-5 rounded-3xl bg-[#15193b]/90 border border-white/15 backdrop-blur-xl shadow-2xl shrink-0"
          >
            <div className="h-14 w-14 rounded-2xl bg-[#ff7a00]/15 border border-[#ff7a00]/40 flex items-center justify-center text-[#ff7a00] shadow-[0_0_20px_rgba(255,122,0,0.3)]">
              <MessageSquare size={26} />
            </div>
            <div>
              <div className="text-xs font-bold uppercase tracking-wider text-slate-400">Live Assistance</div>
              <div className="text-sm sm:text-base font-black text-white">Instant Chat Queue Active</div>
              <div className="text-[0.72rem] text-[#ff7a00] font-medium flex items-center gap-1 mt-0.5">
                <Zap size={12} />
