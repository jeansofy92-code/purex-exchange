...
import { Check, Zap, Star, ShieldCheck, ArrowRight, Sparkles, Cpu, Award } from 'lucide-react'
...
export default function InvestmentPackages() {
  ...
  return (
    <section id="packages" className="section-spacing" style={{ backgroundColor: '#080808' }}>
      <div className="container-max">
        ...
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <p style={{ color: '#c5c5c5', maxWidth: '640px', margin: '0 auto', fontSize: '1.05rem' }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  borderColor: isSelected ? 'var(--accent-primary)' : pkg.highlight ? 'rgba(176, 241, 39, 0.4)' : '#232323',
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      backgroundColor: pkg.highlight ? '#B0F127' : 'rgba(255, 255, 255, 0.08)',
                  ...
                  <div style={{ marginBottom: '2rem' }}>
                    ...
                    <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                      {pkg.features.map((feat, idx) => (
                        <li key={idx} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5rem', fontSize: '0.825rem', color: '#c5c5c5' }}>
