...
export default function ProEcosystemSuite() {
  return (
    <section className="relative mx-auto max-w-[1440px] px-3.5 py-4 sm:px-6 lg:px-10">
      <div className="rounded-2xl border border-amber-500/20 bg-gradient-to-br from-[#0a0c10] via-[#07090d] to-[#040507] p-5 sm:p-7 shadow-2xl overflow-hidden">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-slate-800 bg-slate-950/80 p-2.5">
                <Shield size={14} className="text-amber-400 mb-1" />
              ...
              <div className="rounded-xl border border-slate-800 bg-slate-950/80 p-2.5">
                <Code2 size={14} className="text-amber-400 mb-1" />
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              <button
                type="button"
                className="flex items-center gap-2.5 rounded-xl border border-slate-700 bg-slate-900 px-3.5 py-2 hover:border-amber-400 hover:bg-slate-800 transition-all cursor-pointer text-left shadow"
              >
              ...
              <button
                ...
                className="flex items-center gap-2.5 rounded-xl border border-slate-700 bg-slate-900 px-3.5 py-2 hover:border-amber-400 hover:bg-slate-800 transition-all cursor-pointer text-left shadow"
              >
                <Play size={16} className="text-amber-400" fill="#fbbf24" />
                <div>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="rounded-2xl border border-slate-800 bg-slate-950 p-5 text-center max-w-xs w-full shadow-2xl space-y-3">
              <div className="mx-auto flex h-32 w-32 items-center justify-center rounded-2xl border-2 border-amber-500/40 bg-white p-2.5 shadow-[0_0_24px_rgba(245,158,11,0.25)]">
              ...
              <div className="border-t border-slate-800 pt-2.5">
                <Link
                  to="/trade"
                  className="w-full inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-amber-400 via-amber-300 to-yellow-400 py-2.5 text-xs font-black text-slate-950 shadow-[0_0_15px_rgba(245,158,11,0.4)] uppercase tracking-wider hover:scale-[1.02] transition-all"
                >
