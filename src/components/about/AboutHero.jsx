...
function AboutHero() {
  return (
    <section className="relative pt-12 pb-16 lg:pt-20 lg:pb-24 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-[#58e65b]/10 blur-[120px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            {/* Top Mission Pill */}
            <div className="inline-flex items-center gap-2 rounded-full border border-[#58e65b]/30 bg-[#183a1d]/60 px-4 py-1.5 text-xs font-bold text-[#58e65b] backdrop-blur-md shadow-[0_0_15px_rgba(88,230,91,0.2)]">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white leading-[1.12]">
              ...
              <span className="bg-gradient-to-r from-[#58e65b] via-[#85f487] to-[#38bdf8] bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(88,230,91,0.3)]">
                Effortless, Profitable & Accessible
              </span>
            </h1>

            {/* Mission & Vision Narrative Write-up */}
            <div className="space-y-4 text-[#8d9691] text-base sm:text-lg leading-relaxed font-normal">
              <p>
              ...
              <p className="text-sm sm:text-base text-[#dfe9e2]/80">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
              <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] p-3 backdrop-blur-sm">
                <div className="rounded-lg bg-[#183a1d] p-2 text-[#58e65b]">
                  <TrendingUp size={18} />
                </div>
                <div>
                  <div className="text-xs font-bold text-white">Daily ROI</div>
                  <div className="text-[0.7rem] text-[#8d9691]">Up to 4.5% Daily</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] p-3 backdrop-blur-sm">
                ...
                <div>
                  ...
                  <div className="text-[0.7rem] text-[#8d9691]">Principal Guarantee</div>
                </div>
              </div>

              <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] p-3 backdrop-blur-sm col-span-2 sm:col-span-1">
                <div className="rounded-lg bg-[#183a1d] p-2 text-[#58e65b]">
                  <Zap size={18} />
                </div>
                <div>
                  <div className="text-xs font-bold text-white">Instant Payout</div>
                  <div className="text-[0.7rem] text-[#8d9691]">24/7 Withdrawals</div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative rounded-3xl border border-white/15 bg-[#080d0e]/90 p-6 sm:p-8 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] overflow-hidden">
              <div className="absolute top-0 right-0 w-44 h-44 bg-[#58e65b]/15 rounded-full blur-3xl pointer-events-none" />
              
              <div className="space-y-6 relative z-10">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <div>
                    <div className="text-xs font-semibold text-[#8d9691] uppercase tracking-wider">Our Core Philosophy</div>
                    <div className="text-lg font-bold text-white">Financial Freedom Without Complexity</div>
                  </div>
                  <div className="h-10 w-10 rounded-xl bg-[#183a1d] flex items-center justify-center text-[#58e65b]">
                    <Users size={20} />
                  </div>
                </div>
                ...
                <div className="space-y-3.5">
                  <div className="flex gap-3">
                    <div className="mt-1 h-2 w-2 rounded-full bg-[#58e65b] shadow-[0_0_8px_#58e65b] shrink-0" />
                    <p className="text-xs text-[#dfe9e2]/90 leading-relaxed">
                  ...
                  <div className="flex gap-3">
                    <div className="mt-1 h-2 w-2 rounded-full bg-yellow-400 shadow-[0_0_8px_#eab308] shrink-0" />
                    <p className="text-xs text-[#dfe9e2]/90 leading-relaxed">
                ...
                <div className="rounded-2xl border border-[#58e65b]/30 bg-gradient-to-br from-[#183a1d]/80 to-[#0d2211]/90 p-4 shadow-[0_0_25px_rgba(88,230,91,0.15)]">
                  <div className="flex items-center justify-between text-xs text-[#8d9691]">
                    <span>Average Client Daily Yield</span>
                    <span className="text-[#58e65b] font-bold">100% On Time</span>
                  </div>
                  <div className="flex items-baseline gap-2 mt-1">
                    <div className="text-2xl sm:text-3xl font-black text-white font-mono">+2.85%</div>
                    <div className="text-xs font-semibold text-[#58e65b]">Daily Avg Across Plans</div>
                  </div>
                  <div className="mt-3 flex items-center justify-between text-[0.7rem] text-[#dfe9e2]/70 pt-2 border-t border-white/10">
