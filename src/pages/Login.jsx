...
export default function Login() {
  ...
  return (
    <main className="home-page-shell min-h-screen relative flex items-center justify-center px-4 py-12 sm:px-6 lg:px-10 text-white">
      {/* Background ambient lighting effects */}
      <div className="absolute top-1/4 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[450px] bg-gradient-to-tr from-[#58e65b]/12 via-[#183a1d]/18 to-transparent rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[400px] h-[300px] bg-[#58e65b]/8 rounded-full blur-3xl pointer-events-none" />

      <div className="w-full max-w-6xl z-10">
        {/* Main Grid Layout: Auth Form (Left/Center) & Showcase (Right) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <div className="hidden sm:flex items-center gap-2 rounded-full border border-[#58e65b]/30 bg-[#183a1d]/50 px-3 py-1 text-xs font-semibold text-[#58e65b]">
                <span className="h-2 w-2 rounded-full bg-[#58e65b] animate-pulse" />
            ...
            <motion.div
              ...
              className="rounded-3xl border border-white/15 bg-[#080d0e]/95 p-6 sm:p-8 backdrop-blur-2xl shadow-[0_24px_80px_rgba(0,0,0,0.9)] relative overflow-hidden"
            >
                ...
                <>
                  ...
                  <div className="grid grid-cols-4 gap-1 rounded-2xl bg-black/60 p-1 mb-6 border border-white/10">
                    <button
                      ...
                      className={`rounded-xl py-2 text-[11px] sm:text-xs font-bold transition-all ${
                        activeTab === 'login'
                    ...
                    <button
                      ...
                      className={`rounded-xl py-2 text-[11px] sm:text-xs font-bold transition-all flex items-center justify-center gap-1 ${
                        activeTab === 'qrcode'
                          ? 'bg-[#183a1d] text-[#58e65b] shadow-[0_0_15px_rgba(88,230,91,0.2)] border border-[#58e65b]/30'
                          : 'text-[#8d9691] hover:text-white'
                      }`}
                  ...
                  {activeTab === 'qrcode' && (
                    <div className="text-center py-2 space-y-4">
                      ...
                      <div className="relative mx-auto w-48 h-48 rounded-2xl bg-black border-2 border-[#58e65b]/40 p-3 shadow-[0_0_30px_rgba(88,230,91,0.25)] flex items-center justify-center overflow-hidden">
            ...
            <div className="mt-6 flex items-center justify-between text-[11px] text-[#8d9691] px-2">
          ...
          {/* ================= RIGHT COLUMN: INSTITUTIONAL SHOWCASE ================= */}
          <div className="hidden lg:flex lg:col-span-5 flex-col justify-between space-y-6">
            ...
            <motion.div
              ...
              className="rounded-3xl border border-white/15 bg-[#080d0e]/80 p-6 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] relative"
            >
              <div className="flex items-center justify-between pb-4 border-b border-white/10 mb-4">
                <div className="flex items-center gap-2">
                  <Activity size={16} className="text-[#58e65b]" />
                  <span className="text-xs font-bold uppercase tracking-wider text-white">Live Institutional Liquidity</span>
                </div>
              ...
              <div className="space-y-3">
                {marketPrices.map((item) => (
                  <div
                    key={item.symbol}
                    className="flex items-center justify-between rounded-xl bg-white/[0.02] p-2.5 hover:bg-white/[0.05] transition-colors"
                  >
                    <div>
            ...
            <motion.div
              ...
              className="rounded-3xl border border-white/15 bg-[#080d0e]/80 p-6 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.6)]"
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-2xl border border-white/10 bg-black/40 p-3">
                  ...
                  <div className="font-mono text-lg font-black text-[#58e65b] mt-0.5">&lt; 4.2ms</div>
                  <div className="text-[10px] text-[#8d9691] mt-0.5">Equinix NY4 / LD4</div>
                </div>

                <div className="rounded-2xl border border-white/10 bg-black/40 p-3">
                  <div className="text-[10px] text-[#8d9691]">SAFU Insurance</div>
                  <div className="font-mono text-lg font-black text-white mt-0.5">$500M+</div>
                  <div className="text-[10px] text-[#8d9691] mt-0.5">Multi-Sig Cold Vault</div>
                </div>

                <div className="rounded-2xl border border-white/10 bg-black/40 p-3">
                  <div className="text-[10px] text-[#8d9691]">24h Volume</div>
                  <div className="font-mono text-lg font-black text-white mt-0.5">$2.48B</div>
                  <div className="text-[10px] text-[#8d9691] mt-0.5">Tier 1 Deep Book</div>
                </div>

                <div className="rounded-2xl border border-white/10 bg-black/40 p-3">
                  <div className="text-[10px] text-[#8d9691]">Proof of Reserves</div>
                  <div className="font-mono text-lg font-black text-[#58e65b] mt-0.5">100% Verified</div>
                  <div className="text-[10px] text-[#8d9691] mt-0.5">Merkle Tree Audited</div>
                </div>
              </div>
            </motion.div>

            {/* Gateway Nodes Health Status */}
            <div className="rounded-2xl border border-[#58e65b]/20 bg-[#183a1d]/30 p-4 flex items-center justify-between text-xs">
              <div className="flex items-center gap-2.5">
                <span className="flex h-2.5 w-2.5 rounded-full bg-[#58e65b] animate-ping" />
                <span className="font-semibold text-[#dfe9e2]">Trading Nodes: 100% Operational</span>
              </div>
              <span className="text-[11px] font-mono text-[#8d9691]">0.8ms jitter</span>
            </div>
